...
import { RequestParameters } from './fetch'
import { Team } from './team'

export interface PagedReplaysResponse {
  page: number
  page_count: number
  total: number
  per_page: number
...
export interface ReplayListRequestParameters extends RequestParameters {
...
export interface ReplayPostRequestParameters extends RequestParameters {
  file: FormData
}
